function Set-SGApiKey {
    ...
    .EXAMPLE
        PS C:\> Set-SGApiKey -UniqueId 'SG.aBcDeFg123.456hIjKlMnOpQr' -Scopes 'access_settings.activity.read', 'alerts.create', 'alerts.read'

        This command updates the scopes of the API Key with the specified ID within the current SendGrid instance.

    .EXAMPLE
        PS C:\> Set-SGApiKey -UniqueId 'SG.aBcDeFg123.456hIjKlMnOpQr' -Scopes 'access_settings.activity.read', 'alerts.create', 'alerts.read' -NewName 'MyUpdatedKey'
